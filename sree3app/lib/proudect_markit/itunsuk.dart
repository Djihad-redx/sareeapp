...
class Itunsuk extends StatefulWidget {
  Itunsuk({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _ItunsukState createState() => _ItunsukState();
}

class _ItunsukState extends State<Itunsuk> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1185');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات ايتونز بيرطاني',style: TextStyle(color: Colors.black)),
