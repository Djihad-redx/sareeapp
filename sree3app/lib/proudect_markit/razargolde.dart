...
class Razrgolde extends StatefulWidget {
  Razrgolde({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _RazrgoldeState createState() => _RazrgoldeState();
}

class _RazrgoldeState extends State<Razrgolde> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '664');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات رازر غولد',style: TextStyle(color: Colors.black)),
