...
class Karem extends StatefulWidget {
  Karem({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _KaremState createState() => _KaremState();
}
...
class _KaremState extends State<Karem> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '435');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات كريم',style: TextStyle(color: Colors.black) ),
