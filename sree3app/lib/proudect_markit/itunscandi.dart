...
class tunscandi extends StatefulWidget {
  tunscandi({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _tunscandiState createState() => _tunscandiState();
}

class _tunscandiState extends State<tunscandi> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1186');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات ايتونز كندي',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/ituns.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
