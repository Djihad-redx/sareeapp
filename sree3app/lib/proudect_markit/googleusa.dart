...
class Googleusa extends StatefulWidget {
  Googleusa({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _GoogleusaState createState() => _GoogleusaState();
}

class _GoogleusaState extends State<Googleusa> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '661');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات كوكل بلي امريكي',style: TextStyle(color: Colors.black)),
