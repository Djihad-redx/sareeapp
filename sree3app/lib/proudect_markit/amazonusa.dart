...
class Amazonusa extends StatefulWidget {
  Amazonusa({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _AmazonusaState createState() => _AmazonusaState();
}

class _AmazonusaState extends State<Amazonusa> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '662');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات امزون امريكي',style: TextStyle(color: Colors.black)),
