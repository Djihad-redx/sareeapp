...
class Marsol extends StatefulWidget {
  Marsol({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _MarsolState createState() => _MarsolState();
}

class _MarsolState extends State<Marsol> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1224');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات مرسول',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/mrsol.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
