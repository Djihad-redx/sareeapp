...
class Tmmmt extends StatefulWidget {
  Tmmmt({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _TmmmtState createState() => _TmmmtState();
}

class _TmmmtState extends State<Tmmmt> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1225');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات Tmmt',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage:  AssetImage('assets/imge/logos/tmmt.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
