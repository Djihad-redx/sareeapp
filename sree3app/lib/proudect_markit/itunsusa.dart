...
class Itunsusa extends StatefulWidget {
  Itunsusa({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _ItunsusaState createState() => _ItunsusaState();
}

class _ItunsusaState extends State<Itunsusa> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '663');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات ايتونز امريكي',style: TextStyle(color: Colors.black)),
