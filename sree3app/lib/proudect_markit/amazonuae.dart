...
class Amazonuae extends StatefulWidget {
  Amazonuae({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _AmazonuaeState createState() => _AmazonuaeState();
}

class _AmazonuaeState extends State<Amazonuae> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1208');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات امزون اماراتي',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/amazon.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
