...
class Itunsuae extends StatefulWidget {
  Itunsuae({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _ItunsuaeState createState() => _ItunsuaeState();
}

class _ItunsuaeState extends State<Itunsuae> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1184');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات ايتونز اماراتي',style: TextStyle(color: Colors.black)),
