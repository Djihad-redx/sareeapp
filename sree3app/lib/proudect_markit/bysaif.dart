...
class Bysaif extends StatefulWidget {
  Bysaif({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _BysaifState createState() => _BysaifState();
}

class _BysaifState extends State<Bysaif> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '668');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات باي سيف',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: NetworkImage(product.images[0].src),
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
