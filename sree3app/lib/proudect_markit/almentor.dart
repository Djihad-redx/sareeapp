...
class Almentor extends StatefulWidget {
  Almentor({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _AlmentorState createState() => _AlmentorState();
}

class _AlmentorState extends State<Almentor> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1226');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات Almentor',style: TextStyle(color: Colors.black)),
