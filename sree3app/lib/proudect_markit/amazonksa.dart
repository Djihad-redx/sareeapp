...
class Amazonksa extends StatefulWidget {
  Amazonksa({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _AmazonksaState createState() => _AmazonksaState();
}

class _AmazonksaState extends State<Amazonksa> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1230');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات امزون سعودي',style: TextStyle(color: Colors.black)),
