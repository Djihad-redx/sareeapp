...
class Itunsksa extends StatefulWidget {
  Itunsksa({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _ItunsksaState createState() => _ItunsksaState();
}

class _ItunsksaState extends State<Itunsksa> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '665');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات ايتونز سعودي',style: TextStyle(color: Colors.black)),
