...
class Googleuae extends StatefulWidget {
  Googleuae({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _GoogleuaeState createState() => _GoogleuaeState();
}

class _GoogleuaeState extends State<Googleuae> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1195');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات كوكل بلي اماراتي',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/google.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
