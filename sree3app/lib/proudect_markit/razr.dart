...
class Razr extends StatefulWidget {
  Razr({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _RazrState createState() => _RazrState();
}

class _RazrState extends State<Razr> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1217');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات رازر غولد امريكي',style: TextStyle(color: Colors.black)),
