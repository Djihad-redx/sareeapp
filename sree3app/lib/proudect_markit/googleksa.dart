...
class Googleksa extends StatefulWidget {
  Googleksa({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _GoogleksaState createState() => _GoogleksaState();
}

class _GoogleksaState extends State<Googleksa> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '667');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات كوكل بلي سعودي',style: TextStyle(color: Colors.black)),
