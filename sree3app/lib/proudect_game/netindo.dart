...
class Netendo extends StatefulWidget {
  Netendo({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _NetendoState createState() => _NetendoState();
}

class _NetendoState extends State<Netendo> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '409');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات لوردس',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/netendo.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
