...
class Leag extends StatefulWidget {
  Leag({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _LeagState createState() => _LeagState();
}

class _LeagState extends State<Leag> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1221');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات Mobil legends',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/mobillegend.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
