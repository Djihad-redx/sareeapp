...
class Xboxusa extends StatefulWidget {
  Xboxusa({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _XboxusaState createState() => _XboxusaState();
}

class _XboxusaState extends State<Xboxusa> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '407');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات اكسبوكس امريكي',style: TextStyle(color: Colors.black)),
