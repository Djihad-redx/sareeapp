...
class Pubg extends StatefulWidget {
  Pubg({Key key, this.title}) : super(key: key);
...
class _PubgState extends State<Pubg> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '439');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات ببجي',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/pubg.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
