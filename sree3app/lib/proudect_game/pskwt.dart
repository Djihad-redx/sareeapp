...
class Ps4kwt extends StatefulWidget {
  Ps4kwt({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Ps4kwtState createState() => _Ps4kwtState();
}

class _Ps4kwtState extends State<Ps4kwt> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1206');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بلي ستيشن كويتي',style: TextStyle(color: Colors.black)),
