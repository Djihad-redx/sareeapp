...
class Lors extends StatefulWidget {
  Lors({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _LorsState createState() => _LorsState();
}

class _LorsState extends State<Lors> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1222');
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/lord.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
