...
class Glsat extends StatefulWidget {
  Glsat({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _GlsatState createState() => _GlsatState();
}

class _GlsatState extends State<Glsat> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1219');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text(' جلسات شحن VIP',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/vip.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
