...
class Ps4bahrin extends StatefulWidget {
  Ps4bahrin({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Ps4bahrinState createState() => _Ps4bahrinState();
}

class _Ps4bahrinState extends State<Ps4bahrin> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1199');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بلي ستيشن البحرين',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/play.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
