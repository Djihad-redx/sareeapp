...
class Ps4oman extends StatefulWidget {
  Ps4oman({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Ps4omanState createState() => _Ps4omanState();
}

class _Ps4omanState extends State<Ps4oman> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1213');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بلي ستيشن عماني',style: TextStyle(color: Colors.black)),
