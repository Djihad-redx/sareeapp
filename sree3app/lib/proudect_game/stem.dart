...
class _StemState extends State<Stem> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '441');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات ستيم',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/stem.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
