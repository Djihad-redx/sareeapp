...
class Ps4ksa extends StatefulWidget {
  Ps4ksa({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Ps4ksaState createState() => _Ps4ksaState();
}

class _Ps4ksaState extends State<Ps4ksa> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '413');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بلي ستيشن سعودي',style: TextStyle(color: Colors.black)),
