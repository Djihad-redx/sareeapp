...
class Freefair extends StatefulWidget {
  Freefair({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _FreefairState createState() => _FreefairState();
}

class _FreefairState extends State<Freefair> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1220');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات فري فاير',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/free.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
