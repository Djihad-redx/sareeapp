...
class Ps4usa extends StatefulWidget {
  Ps4usa({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Ps4usaState createState() => _Ps4usaState();
}

class _Ps4usaState extends State<Ps4usa> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '408');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بلي ستيشن امريكي',style: TextStyle(color: Colors.black)),
