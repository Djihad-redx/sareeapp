...
class Xboxuae extends StatefulWidget {
  Xboxuae({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _XboxuaeState createState() => _XboxuaeState();
}

class _XboxuaeState extends State<Xboxuae> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1210');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات اكسبوكس اماراتي',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/xbox.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
