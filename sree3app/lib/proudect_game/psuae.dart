...
class Ps4uae extends StatefulWidget {
  Ps4uae({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Ps4uaeState createState() => _Ps4uaeState();
}

class _Ps4uaeState extends State<Ps4uae> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1197');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بلي ستيشن اماراتي',style: TextStyle(color: Colors.black)),
