...
class Ps4lib extends StatefulWidget {
  Ps4lib({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Ps4libState createState() => _Ps4libState();
}

class _Ps4libState extends State<Ps4lib> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1212');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بلي ستيشن لبناني',style: TextStyle(color: Colors.black)),
