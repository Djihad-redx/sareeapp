...
class Xboxksa extends StatefulWidget {
  Xboxksa({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _XboxksaState createState() => _XboxksaState();
}

class _XboxksaState extends State<Xboxksa> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '427');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات اكسبوكس سعودي',style: TextStyle(color: Colors.black)),
