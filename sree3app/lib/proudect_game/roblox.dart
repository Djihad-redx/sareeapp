...
class Roblox extends StatefulWidget {
  Roblox({Key key, this.title}) : super(key: key);
...
class _RobloxState extends State<Roblox> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1223');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات Roblox',style: TextStyle(color: Colors.black)),
