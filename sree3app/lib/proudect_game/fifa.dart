...
class Fifa extends StatefulWidget {
  Fifa({Key key, this.title}) : super(key: key);
...
class _FifaState extends State<Fifa> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '454');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات فيفا',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/fifa.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
