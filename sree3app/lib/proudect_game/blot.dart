...
class Blot extends StatefulWidget {
  Blot({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _BlotState createState() => _BlotState();
}

class _BlotState extends State<Blot> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1218');
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/blot.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
