...
class Skype extends StatefulWidget {
  Skype({Key key, this.title}) : super(key: key);
  final String title;
  ...
  @override
  SkypeState createState() => SkypeState();
}

class SkypeState extends State<Skype> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1291',);
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات Skype',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/skype.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
