...
class Windos extends StatefulWidget {
  Windos({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _WindosState createState() => _WindosState();
}

class _WindosState extends State<Windos> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1286');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات مايكرو سوفت ويندوز',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage:  AssetImage('assets/imge/logos/win.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
