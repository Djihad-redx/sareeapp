...
class Macfe extends StatefulWidget {
  Macfe({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _MacfeState createState() => _MacfeState();
}

class _MacfeState extends State<Macfe> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1284');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات مكافي',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage:  AssetImage('assets/imge/logos/macafe.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
