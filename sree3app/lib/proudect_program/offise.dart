...
class Offise extends StatefulWidget {
  Offise({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _OffisesState createState() => _OffisesState();
}

class _OffisesState extends State<Offise> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1287');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات مايكرو سوفت اوفس',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage:  AssetImage('assets/imge/logos/offic.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
