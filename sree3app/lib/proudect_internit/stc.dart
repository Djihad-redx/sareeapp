...
class Stc extends StatefulWidget {
  Stc({Key key, this.title}) : super(key: key);
...
class _StcState extends State<Stc> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '422');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات بيانات QUIC NET',style: TextStyle(color: Colors.black)),
