...
class Friendi extends StatefulWidget {
  Friendi({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _FriendiState createState() => _FriendiState();
}

class _FriendiState extends State<Friendi> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '424');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات بيانات Frindi',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/frendi.png'),
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
