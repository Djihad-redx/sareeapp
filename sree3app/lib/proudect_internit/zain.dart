...
class Zain1 extends StatefulWidget {
  Zain1({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Zain1State createState() => _Zain1State();
}

class _Zain1State extends State<Zain1> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '416');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات بيانات Zain',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/zain.png'),
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
                            children: [
                              ...
                              Text(
                                'SAR  '+ product.price,textDirection: TextDirection.rtl,
