...
class Leabara extends StatefulWidget {
  Leabara({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _LeabaraState createState() => _LeabaraState();
}

class _LeabaraState extends State<Leabara> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '429');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات بيانات Leabara',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/lebara.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
