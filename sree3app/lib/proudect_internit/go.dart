...
class Go extends StatefulWidget {
  Go({Key key, this.title}) : super(key: key);
...
class _GoState extends State<Go> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '438');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات بيانات GO',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/go.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
