...
class Mobily1 extends StatefulWidget {
  Mobily1({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Mobily1State createState() => _Mobily1State();
}

class _Mobily1State extends State<Mobily1> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '421');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات بيانات Mobily',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/mobily.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
