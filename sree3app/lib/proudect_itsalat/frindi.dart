...
class Frindi extends StatefulWidget {
  Frindi({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _FrindiState createState() => _FrindiState();
}

class _FrindiState extends State<Frindi> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '418');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات اتصالات Frindi',style: TextStyle(color: Colors.black)),
