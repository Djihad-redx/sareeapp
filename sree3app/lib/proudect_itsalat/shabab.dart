...
class Shabab extends StatefulWidget {
  Shabab({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _ShababState createState() => _ShababState();
}

class _ShababState extends State<Shabab> {
  ...
  getProducts() async {
    products = await wooCommerce.getProducts(category: '1294');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('باقات شباب Zain',style: TextStyle(color: Colors.black)),
