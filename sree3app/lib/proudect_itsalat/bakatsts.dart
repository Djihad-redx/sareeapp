...
class Bstc extends StatefulWidget {
  Bstc({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _BstcState createState() => _BstcState();
}

class _BstcState extends State<Bstc> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1295');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات STC',style: TextStyle(color: Colors.black)),
