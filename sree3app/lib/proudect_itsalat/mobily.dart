...
class Mobily extends StatefulWidget {
  Mobily({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _MobilyState createState() => _MobilyState();
}

class _MobilyState extends State<Mobily> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '412');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات اتصالات Mobily',style: TextStyle(color: Colors.black)),
