...
class Virgin extends StatefulWidget {
  Virgin({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _VirginState createState() => _VirginState();
}

class _VirginState extends State<Virgin> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '417');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات اتصالات Virgin',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/virgin.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
