...
class Lebara extends StatefulWidget {
  Lebara({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _LebaraState createState() => _LebaraState();
}

class _LebaraState extends State<Lebara> {
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات اتصالات Lebara',style: TextStyle(color: Colors.black)),
