...
class Zain extends StatefulWidget {
  Zain({Key key, this.title}) : super(key: key);
...
class _ZainState extends State<Zain> {
  ...
  getProducts() async {
    products = await wooCommerce.getProducts(category: '411');
    ...
    Scaffold(
      endDrawer: AppDrawer(),
           appBar:  AppBar(
             ...
             title: Text('بطاقات اتصال Zain',style: TextStyle(color: Colors.black)),
