...
class Nteflixuae extends StatefulWidget {
  Nteflixuae({Key key, this.title}) : super(key: key);
...
class _NteflixuaeState extends State<Nteflixuae> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1214');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات بطاقات نتفلكس اماراتي',style: TextStyle(color: Colors.black)),
