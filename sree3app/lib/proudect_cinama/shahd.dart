...
class Shahd extends StatefulWidget {
  Shahd({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _ShahdState createState() => _ShahdState();
}

class _ShahdState extends State<Shahd> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1215');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات شاهد',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/sha.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
