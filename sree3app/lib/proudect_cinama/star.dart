...
class Star extends StatefulWidget {
  Star({Key key, this.title}) : super(key: key);
...
class _StarState extends State<Star> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1227');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات ستار بلي',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/starz.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
