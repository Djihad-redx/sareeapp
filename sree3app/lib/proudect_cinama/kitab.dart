...
class Kitab extends StatefulWidget {
  Kitab({Key key, this.title}) : super(key: key);
...
class _KitabState extends State<Kitab> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1216');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات كتاب الصوتية',style: TextStyle(color: Colors.black)),
                          ...
                          children: <Widget>[
                            ...
                            ListTile(
                              leading: CircleAvatar(
                                  radius: 24.0,
                                  backgroundImage: AssetImage('assets/imge/logos/kitap.png')
                              ),
                              title: Row(
                                children: <Widget>[
                                  Column(
