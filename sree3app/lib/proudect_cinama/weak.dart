...
class Weak extends StatefulWidget {
  Weak({Key key, this.title}) : super(key: key);
...
class _WeakState extends State<Weak> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1229');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات وياك',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/weak.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
