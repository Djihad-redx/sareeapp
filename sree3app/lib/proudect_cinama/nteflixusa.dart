...
class Nteflixusa extends StatefulWidget {
  Nteflixusa({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _NteflixusaState createState() => _NteflixusaState();
}

class _NteflixusaState extends State<Nteflixusa> {
  ...
  getProducts() async{
    products = await wooCommerce.getProducts(category: '1202');
    ...
    return
      Scaffold(
        ...
        appBar:  AppBar(
          ...
          title: Text('بطاقات نتفلكس امريكي',style: TextStyle(color: Colors.black)),
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        radius: 24.0,
                        backgroundImage: AssetImage('assets/imge/logos/netflix.png')
                      ),
                      title: Row(
                        children: <Widget>[
                          Column(
